...
public class FilmShowing extends Film {
	...
	/* GETTERS AND SETTERS FOR FILMSHOWING CLASS */
	...
	public void setStrScreen(String _strScreenNum) {
	...
	/**
	 * methods to get all the showings by certain parameters
	 */
	...
	/**
	 * method to generate an ID for FilmShowing
	 * 
	 * @return the showing ID
	 */

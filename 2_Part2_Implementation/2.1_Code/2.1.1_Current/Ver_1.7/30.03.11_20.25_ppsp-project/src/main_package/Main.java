...
public class Main {
	...
	public static void main(String[] args) {
		...
		Film flm4 = new Film("The Thomas Crown Affair", 15);
		Film flm5 = new Film("1984", 15);
		Film flm6 = new Film("", 18);
		...
		FilmShowing fs4 = new FilmShowing(flm4, "27/03/2011", screen2, 4.99);
		FilmShowing fs5 = new FilmShowing(flm5, "27/03/2011", screen2, 5.99);
		FilmShowing fs6 = new FilmShowing(flm6, "27/03/2011", screen1, 5.99);
		...
		showings.addFilmShowing(fs5);
		showings.addFilmShowing(fs6);

		// constructing a new customer
		Customer cst1 = new Customer("Dave", "Russell", 21, "07533475113");
		Customer cst2 = new Customer("Amanda", "Patterson", 21, "0102120302");
		Customer cst3 = new Customer("James", "Nightingale", 20, "02020200202");
		Customer cst4 = new Customer("Scott", "Dennison", 20, "1212123123");
		
		customers.addCustomer(cst1);
		customers.addCustomer(cst2);
		customers.addCustomer(cst3);
		customers.addCustomer(cst4);
							...
							try {
								...
								case 4:
									...
									try {
										...
										bookings.cancelBooking(intCase);
									}
									catch (Exception e) {

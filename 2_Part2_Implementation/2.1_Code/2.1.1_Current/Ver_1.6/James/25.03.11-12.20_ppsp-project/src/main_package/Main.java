...
public class Main {
	...
	static Staff stf1 = new Staff("James", "Nightingale", 20, "07123283823", 456,
	...
	public static void main(String[] args) {
		...
		FilmShowing fs1 = new FilmShowing(1, flm1.getIntFilmID(),
				"01/02/2010", screen1.getStrScreen(), 4.99);
		FilmShowing fs2 = new FilmShowing(2, flm2.getIntFilmID(),
				"12/12/2011", screen1.getStrScreen(), 6.80);
		FilmShowing fs3 = new FilmShowing(3, flm3.getIntFilmID(),
				"12/12/2011", screen1.getStrScreen(), 4.99);
	...
	public static boolean loginAdminFunction() {
		...
		if (strInputPassword.equalsIgnoreCase(strAdminPassword)) {
			...
			System.out.println("Unsuccessful attempt. Exiting program");
			return false;
		}

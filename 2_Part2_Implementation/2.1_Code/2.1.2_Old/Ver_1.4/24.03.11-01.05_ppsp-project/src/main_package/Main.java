...
public class Main {
	...
	public static void main(String[] args) {
		...
		FilmShowing fs1 = new FilmShowing(123, flm1.getIntFilmID(),
				"01/02/2010", screen1.getStrScreen(), 4.99);
		FilmShowing fs2 = new FilmShowing(12, flm2.getIntFilmID(),
				"12/12/2011", screen1.getStrScreen(), 6.80);
		FilmShowing fs3 = new FilmShowing(123, flm3.getIntFilmID(),
		...
		Seats seats = new Seats(1, cst1.getCustomerID(), stf1.getStaffID(),
				fs1.getIntShowingID(), fs1.getDblPrice(), fs1.getDateTime(), 2,
				Row.A, Column.J);
		try {

...
public class Staff extends Person {
	...
	public String toString() {
		String s = "Staff first name: " + strFirstName + " Staff last name: "
				+ strLastName + " Staff age: " + intAge + " "
				+ " Staff Telephone: " + strTelephone + " Staff ID: "
				+ intStaffID + " Staff Role: " + strRole + " Staff Username: "
				+ strUsername + " Staff Password: " + strPassword;

...
public class FilmShowing extends Film {
	 ...
	 *            passed Price
	 */
	public FilmShowing(Film _objFilmID, String _strDate, String _strScreenNum,
			double _dblPrice) {
		intShowingID = generateFSID();
		intFilmID = _objFilmID.getIntFilmID();
	...
	public FilmShowing get(int _intID) {
		for (FilmShowing fs : arrFSArray) {
